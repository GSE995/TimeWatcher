...
describe('AsyncActions for timer testing', () => {
  it('Fetch timers', async () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.fetchTimers(listResult)];
  ...
  it('Add timer', async () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.addTimer(timer)];
  ...
  it('Change timer', async () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.changeTimer(timer)];
  ...
  it('Remove timer', () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.removeTimer(timer.id)];
  ...
  it('Start timer', async () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.startTimer(timer)];
  ...
  it('Stop timer', async () => {
    ...
    const expectedActions = [actions.stopTimer(), actions.addTimer(timer)];
  ...
  it('Change active timer', async () => {
    ...
    const expectedActions = [actions.timerRequest(), actions.changeActiveTimer(timer)];
